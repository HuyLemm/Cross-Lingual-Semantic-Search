...
export default function SourceViewSheet({
  ...
  const renderContext = () => {
    ...
    if (searchQuery) {
      const text = typeof ctx === "string" ? ctx : (qa.context ?? "");
        ...
        <div className="space-y-6 p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 rounded-lg bg-gray-50 border">
              <p className="text-xs text-muted-foreground">Chunk ID</p>
            ...
            <div className="p-3 rounded-lg bg-gray-50 border">
              <p className="text-xs text-muted-foreground">Chunk Char Length</p>
              <p className="text-xl font-mono font-semibold">
                {typeof qa.chunk_char_len === "number"
                  ? qa.chunk_char_len
                  : "N/A"}
              </p>
            </div>

            <div className="col-span-2 p-3 rounded-lg bg-gray-50 border">
              <p className="text-xs text-muted-foreground mb-1">
                Chunk Preview
              </p>
              <div className="text-sm font-mono whitespace-pre-wrap leading-relaxed">
                {qa.chunk_preview?.trim()
                  ? highlight(qa.chunk_preview, searchQuery)
                  : "N/A"}
              </div>
            </div>
          </div>
          ...
          <div className="p-3 rounded-lg bg-gray-50 border">
            ...
            <p className="text-sm font-medium">
              {highlight(qa.sourceDocument ?? "", searchQuery)}
            </p>
