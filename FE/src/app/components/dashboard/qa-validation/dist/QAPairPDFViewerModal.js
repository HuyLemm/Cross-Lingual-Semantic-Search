...
function formatPages(pages) {
    // ✅ pages chưa có dữ liệu -> —
    if (pages === undefined || pages === null || pages <= 0)
        return "—";
    return String(pages);
}
function QAPairPDFViewerModal(_a) {
    var _b, _c;
    var qa = _a.qa, meta = _a.meta, _d = _a.loading, loading = _d === void 0 ? false : _d, _e = _a.error, error = _e === void 0 ? null : _e, onClose = _a.onClose;
    var pdfName = (_c = (_b = meta === null || meta === void 0 ? void 0 : meta.pdfName) !== null && _b !== void 0 ? _b : qa.sourceDocument) !== null && _c !== void 0 ? _c : "Unknown.pdf";
    var sizeText = (meta === null || meta === void 0 ? void 0 : meta.sizeBytes) !== undefined ? formatBytes(meta.sizeBytes) : "—";
    var pagesText = formatPages(meta === null || meta === void 0 ? void 0 : meta.pages);
    var API_BASE = "http://localhost:4000";
    var pdfSrc = (meta === null || meta === void 0 ? void 0 : meta.pdfUrl) ? "" + API_BASE + meta.pdfUrl : "";
    var downloadHref = (meta === null || meta === void 0 ? void 0 : meta.downloadUrl) ? "" + API_BASE + meta.downloadUrl : "";
...
exports["default"] = QAPairPDFViewerModal;
