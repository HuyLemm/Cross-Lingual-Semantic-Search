...
function QAPairValidationTable(_a) {
    var _b = _a.qaPairs, qaPairs = _b === void 0 ? [] : _b, _c = _a.totalQAPairs, totalQAPairs = _c === void 0 ? 0 : _c, page = _a.page, pageSize = _a.pageSize, qualityThreshold = _a.qualityThreshold, searchQuery = _a.searchQuery, _d = _a.loading, loading = _d === void 0 ? false : _d, onSearchChange = _a.onSearchChange, onPageChange = _a.onPageChange, onOpenPdf = _a.onOpenPdf, onViewDetails = _a.onViewDetails;
    ...
    return (React.createElement(card_1.Card, { className: "w-full" },
        ...
        React.createElement(card_1.CardContent, null,
            ...
            React.createElement("div", { className: "w-full overflow-x-auto border rounded-lg" },
                React.createElement(table_1.Table, { className: "min-w-[1200px] table-fixed" },
                    React.createElement(table_1.TableHeader, null,
                        React.createElement(table_1.TableRow, null,
                            ...
                            React.createElement(table_1.TableHead, { className: "w-[120px] text-center" }, "Chunk ID"),
                    ...
                    React.createElement(table_1.TableBody, null,
                        qaPairs.map(function (qa) {
                            ...
                            var bi = (_a = qa.sim_qc) !== null && _a !== void 0 ? _a : 0;
                            var ce = (_b = qa.ce_multi_prob) !== null && _b !== void 0 ? _b : 0;
                            var chunkId = (_c = qa.chunk_id) !== null && _c !== void 0 ? _c : "—";
                            return (React.createElement(table_1.TableRow, { key: qa.id },
                                ...
                                React.createElement(table_1.TableCell, null,
                                    React.createElement("button", { type: "button", onClick: function () { return onOpenPdf(qa); }, className: "group w-full text-left" },
                                        React.createElement(badge_1.Badge, { className: "\n        flex items-center gap-2\n        bg-blue-50 text-blue-700\n        dark:bg-blue-900/30 dark:text-blue-300\n        hover:bg-blue-100 dark:hover:bg-blue-900/50\n        cursor-pointer\n        transition\n        px-3 py-2\n        text-sm\n        font-medium\n        whitespace-normal break-words\n      " },
                                            React.createElement(lucide_react_1.Pin, { className: "!w-4 !h-4 shrink-0 group-hover:rotate-12 transition-transform" }),
                                            React.createElement("span", { className: "group-hover:underline" }, highlight((_d = qa.sourceDocument) !== null && _d !== void 0 ? _d : "Unknown", searchQuery))))),
                                React.createElement(table_1.TableCell, { className: "text-center" },
                                    React.createElement(badge_1.Badge, { variant: "outline", className: "font-mono text-[12px]" }, highlight(String(chunkId), searchQuery))),
                                React.createElement(table_1.TableCell, { className: "text-center" },
                                ...
                                React.createElement(table_1.TableCell, null,
                                    React.createElement("div", { className: "flex justify-center" },
                                        React.createElement(button_1.Button, { variant: "ghost", size: "sm", onClick: function () { return onViewDetails(qa); } },
                                            React.createElement(lucide_react_1.Eye, { className: "w-4 h-4 mr-1" }),
                                            "View")))));
                        }),
                        loading && (React.createElement(table_1.TableRow, null,
                            React.createElement(table_1.TableCell, { colSpan: 10, className: "py-10" },
                                React.createElement("div", { className: "flex justify-center" },
                                    React.createElement(loading_spinner_1["default"], { size: 26 }))))),
                        !loading && qaPairs.length === 0 && (React.createElement(table_1.TableRow, null,
                            React.createElement(table_1.TableCell, { colSpan: 10, className: "text-center py-10 text-gray-500" }, "No QA pairs found")))))),
            React.createElement("div", { className: "mt-4 mb-2 flex justify-center" },
                React.createElement("div", { className: "flex items-center gap-1 text-sm flex-nowrap overflow-x-auto max-w-full px-2" },
                    ...
                    pages.map(function (p, i) {
                        return p === "..." ? (React.createElement("span", { key: "dots-" + i, className: "px-2 text-gray-400 select-none" }, "...")) : (React.createElement(button_1.Button, { key: "page-" + p + "-" + i, size: "sm", variant: Number(p) === page ? "default" : "outline", onClick: function () { return onPageChange(Number(p)); } }, p));
                    }),
