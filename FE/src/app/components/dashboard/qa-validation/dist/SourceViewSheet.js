...
function SourceViewSheet(_a) {
    ...
    var renderContext = function () {
        ...
        if (searchQuery) {
            var text = typeof ctx === "string" ? ctx : ((_c = qa.context) !== null && _c !== void 0 ? _c : "");
            ...
            React.createElement("div", { className: "space-y-6 p-4" },
                ...
                React.createElement("div", { className: "grid grid-cols-2 gap-3" },
                    React.createElement("div", { className: "p-3 rounded-lg bg-gray-50 border" },
                        React.createElement("p", { className: "text-xs text-muted-foreground" }, "Chunk ID"),
                        React.createElement("p", { className: "text-xl font-mono font-semibold" }, (_d = qa.chunk_id) !== null && _d !== void 0 ? _d : "N/A")),
                    React.createElement("div", { className: "p-3 rounded-lg bg-gray-50 border" },
                        React.createElement("p", { className: "text-xs text-muted-foreground" }, "Chunk Char Length"),
                        React.createElement("p", { className: "text-xl font-mono font-semibold" }, typeof qa.chunk_char_len === "number"
                            ? qa.chunk_char_len
                            : "N/A")),
                    React.createElement("div", { className: "col-span-2 p-3 rounded-lg bg-gray-50 border" },
                        React.createElement("p", { className: "text-xs text-muted-foreground mb-1" }, "Chunk Preview"),
                        React.createElement("div", { className: "text-sm font-mono whitespace-pre-wrap leading-relaxed" }, ((_e = qa.chunk_preview) === null || _e === void 0 ? void 0 : _e.trim()) ? highlight(qa.chunk_preview, searchQuery)
                            : "N/A"))),
                React.createElement("div", null,
                    React.createElement("p", { className: "text-xs font-semibold mb-1" }, "Question"),
                    React.createElement("div", { className: "p-3 rounded-lg bg-blue-50 border" }, highlight((_f = qa.question) !== null && _f !== void 0 ? _f : "", searchQuery))),
                React.createElement("div", null,
                    React.createElement("p", { className: "text-xs font-semibold mb-1" }, "Ground Truth Answer"),
                    React.createElement("div", { className: "p-3 rounded-lg bg-green-50 border" }, highlight((_g = qa.answer) !== null && _g !== void 0 ? _g : "", searchQuery))),
                ...
                React.createElement("div", { className: "p-3 rounded-lg bg-gray-50 border" },
                    ...
                    React.createElement("p", { className: "text-sm font-medium" }, highlight((_h = qa.sourceDocument) !== null && _h !== void 0 ? _h : "", searchQuery)),
