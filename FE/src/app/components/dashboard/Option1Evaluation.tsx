...
import TabSummary from "./option1-evaluation/TabSummary";
import TabModelComparison from "./option1-evaluation/TabModelComparison";
import TabLanguage from "./option1-evaluation/TabLanguage";
import TabLatency from "./option1-evaluation/TabLatency";
import TabTables from "./option1-evaluation/TabTables";
...
export default function Option1Evaluation() {
