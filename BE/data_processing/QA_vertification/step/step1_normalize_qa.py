...
INPUT_FILES = {
    ...
    "../../results_from_generate/data_generated/gpt_data/exp7/input7_en_gpt.json": ("gpt-5.2", "en"),
    "../../results_from_generate/data_generated/gpt_data/exp9/input9_vi_gpt.json": ("gpt-5.2", "vi"),
}
...
SELECTED_INPUT = "../../results_from_generate/data_generated/gpt_data/exp9/input9_vi_gpt.json"

PDF_DIR = {
    "en": "../../../backend/data_articles/articles_en",
    "vi": "../../../backend/data_articles/articles_vi"
}

OUTPUT_DIR = "../../results_from_generate/stepResults/step1/exp9"
